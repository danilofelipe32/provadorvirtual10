...
const REMIX_SUGGESTIONS = [
  "Ideia de remix: Gerar um lookbook compartilhável.",
  "Ideia de remix: Integrar com uma API de e-commerce para encontrar itens similares.",
  "Ideia de remix: Adicionar acessórios como chapéus, óculos de sol ou bolsas.",
  "Ideia de remix: Criar uma 'pontuação de estilo' para os visuais.",
  "Ideia de remix: Permitir que usuários salvem seus visuais favoritos.",
  "Ideia de remix: Gerar diferentes combinações de cores para as roupas.",
];
