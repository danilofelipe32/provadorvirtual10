          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Crie Seu Modelo para Qualquer Visual.
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Já imaginou como uma roupa ficaria em você? Pare de adivinhar. Envie uma foto e veja você mesmo. Nossa IA cria seu modelo pessoal, pronto para provar qualquer coisa.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Selecione uma foto nítida e de corpo inteiro. Fotos apenas do rosto também funcionam, mas de corpo inteiro é preferível para melhores resultados.</p>
          ...
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start">
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 text-md text-gray-600">
                Arraste o controle para ver sua transformação.
              </p>
            </div>
